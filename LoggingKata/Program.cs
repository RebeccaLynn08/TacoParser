...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                logger.LogError("Zero lines in csv file");
            }

            if (lines.Length == 1)
            {
                logger.LogWarning("Only one line in csv file");
            }
            ...
            for (int i = 0; i < locations.Length; i++)
            {
                ...
                for (int j = 0; j < locations.Length; j++)
                {
                    ...
                    if (tempDistance > distance)
                    {
                        ...
                        track2.Location = pnt1;
                    }

                }
                
            }
            logger.LogInfo($"The two farthest Taco Bell locations in Alabama in {track1.Name} and {track2.Name} and are {distance * 0.000621371} miles apart");
